...
void handlePacket(void)
{
    ...
    switch (id)
    {
        ...
        case CMD_SET_YAW_SERVO_ANGLE:
        {
            ...
            PwmServo_Set_Angle(YAW_SERVO, angle, 100);
        ...
        case CMD_SET_CLAW_SERVO_ANGLE:
        {
            ...
            PwmServo_Set_Angle(CLAW_SERVO, angle, 100);
        ...
        case CMD_SET_VERTICAL_ARM_POSITION:
        {
            ...
            // TODO: Set_Vertical_Arm_Position(position);
        ...
        case CMD_SET_HORIZONTAL_ARM_POSITION:
        {
            if (len != 0x02) break;
            uint16_t position = (uint16_t)(data[0] | (data[1] << 8));  // little-endian
            // TODO: Set_Horizontal_Arm_Position(position);
        ...
        case CMD_SET_WHEEL_TARGET_VELOCITIES:
        {
            ...
            // TODO: Set_Wheel_Target_Velocities(vfl, vfr, vrl, vrr);
